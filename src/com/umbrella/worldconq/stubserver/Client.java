...
public class Client {
	...
	private static String ruta = "/home/jorgeca/Dropbox/5º Informatica/ISO II/Laboratorio/Repos/workspace/iso2010-11/src/prototypes/rmisample/open.policy";
	...
	public static void main(String[] args) throws Exception {
		...
		IServer prx = null;
		prx = (IServer) Naming.lookup("rmi://"+IP+":"+puerto+"/RMIServer");
		System.out.println("Conectado a :"+"rmi://"+IP+":"+puerto+"/RMIServer");
